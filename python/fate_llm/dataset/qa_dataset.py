...
class RTE:
    ...
    def get_context(self, examples):
        sentences_1 = examples["premise"] if "premise" in examples else examples["sentence1"]
        sentences_2 = examples["hypothesis"] if "hypothesis" in examples else examples["sentence2"]
        contexts = []
